/* GLTFLoader (three.js r185 examples, MIT (c) three.js authors) repacked as a classic
   script: THREE.GLTFLoader. Bundled with its BufferGeometryUtils / SkeletonUtils deps. */
(function(){
'use strict';
var __BGU = (function(){
...
return { computeMikkTSpaceTangents, computeMorphedAttributes, deepCloneAttribute, deinterleaveAttribute, deinterleaveGeometry, estimateBytesUsed, interleaveAttributes, mergeAttributes, mergeGeometries, mergeGroups, mergeVertices, toCreasedNormals, toTrianglesDrawMode };
})();
var __SKU = (function(){
const { AnimationClip, AnimationMixer, Matrix4, Quaternion, QuaternionKeyframeTrack, SkeletonHelper, Vector3, VectorKeyframeTrack } = THREE;
...
return { clone, retarget, retargetClip };
})();
var __GLTF = (function(){
